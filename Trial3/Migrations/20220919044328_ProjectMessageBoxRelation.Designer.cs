...
namespace Trial3.Migrations
{
    ...
    [Migration("20220919044328_ProjectMessageBoxRelation")]
    partial class ProjectMessageBoxRelation
    {
            ...
            modelBuilder.Entity("Trial3.Models.MessageBox", b =>
                {
                    ...
                    b.HasOne("Trial3.Models.Project", "Project")
                        .WithOne("Messagebox")
                        .HasForeignKey("Trial3.Models.MessageBox", "ProjectId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
